...
public class RMD_Editor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.PropertyField(serializedObject.FindProperty("angleObject"), new GUIContent("angleObject", "angleObject"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("woodFx"), new GUIContent("woodFx", "woodFx"));
